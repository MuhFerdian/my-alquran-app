...
function Verse({ verse, surah }: VerseProps) {
  return (
    <div className="bg-[url('/src/assets/VerseBackgroundImage.png')] bg-cover bg-no-repeat p-4 min-h-[130px] rounded-2xl text-left flex flex-col justify-between" style={{ color: 'white' }}>
